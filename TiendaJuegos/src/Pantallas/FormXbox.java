...
public class FormXbox extends JFrame {
    ...
    public FormXbox() {
        ...
        comboConsola = new JComboBox<>(new String[]{"Xbox One", "Xbox Series"});
        ...
        btnAgregar.addActionListener(e -> {
            ...
            // Crear objeto y añadir al carrito con precio normal (Strategy)
            JuegoXbox juego = new JuegoXbox(
                    id,
                    nombre,
                    precio,
                    new PrecioNormal()
