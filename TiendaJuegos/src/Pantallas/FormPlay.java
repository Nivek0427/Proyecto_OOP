...
public class FormPlay extends JFrame {
    ...
    public FormPlay() {
        ...
        comboConsola = new JComboBox<>(new String[]{"PS4", "PS5"});
        ...
        btnAgregar.addActionListener(e -> {
            ...
            // Crear objeto y añadir al carrito (✔ con strategy)
            JuegoPlay juego = new JuegoPlay(id, nombre, precio, new PrecioNormal(),consola);
